                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4" style="margin: 0 10%;">
                        <h1 class="h3 mb-0 text-gray-800">1:1 문의</h1>
                         <a href="noticeWrite" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
						            ...
						            <div class="row no-gutters align-items-center">
						                <div class="col mr-2">
						                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
						                        * 미답변 / 답변중 / 보류 / 답변완료 로 상태 구분되어 있습니다.</div>
						                            ...
						                            <tbody>
						                                ...
						                                <c:forEach items="${noticeList}" var="notice">
						                                    <tr>
						                                        ...
						                                        <td><c:out value="${notice.notiWriter}" /></td>
						                                        <td><c:out value="${notice.notiDate}" /></td>
