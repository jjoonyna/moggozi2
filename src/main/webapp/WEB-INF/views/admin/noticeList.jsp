...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<!-- 대분류 카테고리명 -->
			<div class="sidebar-heading">관리 항목</div>
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="noticeList">공지 사항</a> <a
							class="collapse-item" href="askList">1:1 문의</a>
					</div>
				</div></li>
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-expanded="true" aria-controls="collapseUtilities"> <i
					class="fas fa-fw fa-wrench"></i> <span>관리</span>
			</a>
				<div id="collapseUtilities" class="collapse"
					aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<h6 class="collapse-header">항목</h6>
						<a class="collapse-item" href="userManagement">회원 관리</a> <a
							class="collapse-item" href="postMangement">게시물 관리</a>
					</div>
				</div></li>
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow"><a
							...
							aria-expanded="false"> <span
								class="mr-2 d-none d-lg-inline text-gray-600 small">${usernick}
												...
												<tbody>
													<c:choose>
														<c:when test="${empty noticeList}">
															<tr>
																<td colspan="6" style="text-align: center;">공지사항이
																	없을 꼬지</td>
															</tr>
														</c:when>
														<c:otherwise>
															<c:forEach items="${noticeList}" var="notice">
																<tr>
																	...
																	<td><a href="noticeDetail?id=${notice.notiNo}"><c:out
																				value="${notice.notiTitle}" /></a></td>
																	<td><c:out value="${notice.usernick}" /></td>
																	<td><fmt:formatDate value="${notice.notiDate}"
							...
							<div class="copyright text-center my-auto">
								...
								<div>
									...
									<p>
										...
										: 2024.6.22<br /> Copyright ⓒ 2024&nbsp;임정석. All rights
										reserved.
									</p>
								</div>
							</div>
