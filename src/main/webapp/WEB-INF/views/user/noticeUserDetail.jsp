...
<nav>
    ...
    <section>
        <div class="cards">
                    ...
                    <table class="navClass">
                        <tr class="classLeft">
                            <td class="spanNicks">
                                ...
                                <span class="spanNick2">등록일: <fmt:formatDate value="${notice.notiDate}" pattern="yyyy.MM.dd HH:mm" /></span>
                                <span class="spanNick4">조회수: ${notice.notiHit}</span>
                            </td>
                        </tr>
                        <tr class="classLeft">
                            <td class="taContent">
            ...
            <div class="btn">
			    <input type="button" value="목록" class="listBtn" onclick="window.location.href='noticeUserList?usernick=${usernick}'">
			</div>
        </div>
    </section>
</nav>
